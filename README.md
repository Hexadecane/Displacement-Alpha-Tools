...
3. Compile it. 
4. Copy the .vmf boilerplate files to the compiled directory (`./bin/Debug` or `./bin/Release`)
4. Run it: `./bin/Release/DisplacementAlphaTools.exe` or `./bin/Debug/DisplacementAlphaTools.exe`
